...
% ElSpec_iqtc Estimate primary energy spectra of precipitating electrons from
% EISCAT incoherent scatter data.
%
% ElSpec_iqtc is a variant that does recursive division in time as long as
...
%
% ElSpecOut = ElSpec_iqtc(varargin)
%
%
% INPUT:
%
...
%
%  For example ElSpec_iqtc('ppdir',<path-to-pp-files>)
%
