...
% ElSpec_iqtcl Estimate primary energy spectra of precipitating electrons fromElSpecRes,iT2plot,ops
% EISCAT incoherent scatter data.
% 
% ElSpec_iqtcl is a variant that does recursive division in time as long as
% that is Akaike-information-criteria-justified, and runs the optimization
% with fmincon and lsqnonlin
%
...
%
% ElSpecOut = ElSpec_iqtcl(varargin)
%
%
% INPUT:
%
...
%
% IV 2017, 2018, BG 2020, 2024. This version builds on ElSpec, and
% ElSpec_iqt and ElSpec_iqtc.
%
...
[AICc1,polycoefs1,best_order1,n_params1,ne1,neEnd1,Ie1] = AICcFitParSeq(pp(:,1:Directives.ninteg),...
                                                  ...
                                                  max(1,mean(pp(:,1:Directives.ninteg),2,'omitnan')),...
                                                  A,...
